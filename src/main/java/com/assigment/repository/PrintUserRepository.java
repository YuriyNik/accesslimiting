...
public  class PrintUserRepository implements CrudRepository<User, String> {
    private static final Logger log = LoggerFactory.getLogger(PrintUserRepository.class);
    ...
    public Optional<User> findById(String s) {
        Optional<User> user = Optional.of(new User("mock","fromPrintRepo", LocalDateTime.now()));
        log.info("create and return mock for user id="+s+";"+user);
        return user;
    }
